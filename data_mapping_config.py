...
class DataMappingConfig:
    ...
    def _define_standard_fields(self) -> Dict[str, FieldMapping]:
        ...
        return {
            ...
            'gdc_deepest_depth': FieldMapping('gdc_deepest_depth', 'GDC Deepest depth', 'numeric'),
            ...
            'gdc_location_type': FieldMapping('gdc_location_type', 'GDC Location type', 'string'),
    ...
    def _define_data_categories(self) -> Dict[str, List[str]]:
        ...
        return {
            ...
            'bit_specifications': [
                ...
                'bit_size_category', 'bit_class', 'bit_type', 'iadc_code', 'bit_style', 'blade_count',
                'cutter_size', 'tfa'
            ],
            'run_details': [
            ...
            'gdc_well_data': [
                'gdc_bottom_hole_latitude', 'gdc_bottom_hole_longitude', 'gdc_deepest_depth',
                'gdc_drill_td', 'gdc_final_drill_date', 'gdc_final_td', 'gdc_gsl_days_on',
                'gdc_location_type', 'gdc_max_tvd', 'gdc_profile_type', 'gdc_rig_release_date',
